<div class="mwb-overview__wrapper">
    <div class="mwb-overview__banner">
        <img src="<?php echo esc_html( STOCK_BASED_PRICING_PLUGIN_DIR_URL ); ?>admin/image/banner.jpg" alt="Overview banner image">
    </div>
    <div class="mwb-overview__content">
        ...
        <div class="mwb-overview__keywords">
            <div class="mwb-overview__keywords-item">
                <div class="mwb-overview__keywords-card">
                    <div class="mwb-overview__keywords-image">
                        <img src="<?php echo esc_html( STOCK_BASED_PRICING_PLUGIN_DIR_URL . 'admin/image/Advanced-report.png' ); ?>" alt="Advanced-report image">
                    </div>
            ...
            <div class="mwb-overview__keywords-item">
                <div class="mwb-overview__keywords-card">
                    <div class="mwb-overview__keywords-image">
                        <img src="<?php echo esc_html( STOCK_BASED_PRICING_PLUGIN_DIR_URL . 'admin/image/Workflow.png' ); ?>" alt="Workflow image">
                    </div>
                    <div class="mwb-overview__keywords-text">
            ...
            <div class="mwb-overview__keywords-item">
                <div class="mwb-overview__keywords-card">
                    <div class="mwb-overview__keywords-image">
                        <img src="<?php echo esc_html( STOCK_BASED_PRICING_PLUGIN_DIR_URL . 'admin/image/Variable-product.png' ); ?>" alt="Variable product image">
                    </div>
                    <div class="mwb-overview__keywords-text">
            ...
            <div class="mwb-overview__keywords-item">
                <div class="mwb-overview__keywords-card">
                    <div class="mwb-overview__keywords-image">
                        <img src="<?php echo esc_html( STOCK_BASED_PRICING_PLUGIN_DIR_URL . 'admin/image/List-of-abandoned-users.png' ); ?>" alt="List-of-abandoned-users image">
                    </div>
                    <div class="mwb-overview__keywords-text">
            ...
            <div class="mwb-overview__keywords-item">
                <div class="mwb-overview__keywords-card mwb-card-support">
                    <div class="mwb-overview__keywords-image">
                        <img src="<?php echo esc_html( STOCK_BASED_PRICING_PLUGIN_DIR_URL . 'admin/image/Support.png' ); ?>" alt="Support image">
                    </div>
                    <div class="mwb-overview__keywords-text">
