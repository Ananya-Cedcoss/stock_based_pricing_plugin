 ...
 * @subpackage woocommerce-one-click-upsell-funnel-pro/page-builders/elementor/elementor-widgets
 */
...
class Elementor_Widget {
	...
	public function register_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\Upsell_Additional_Offer() );
