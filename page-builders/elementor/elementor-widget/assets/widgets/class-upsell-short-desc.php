...
class Upsell_Short_Desc extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Upsell Short Description', 'one-click-upsell-funnel-for-woocommerce-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_editor',
			array(
				'label' => esc_html__( 'Text Editor', 'one-click-upsell-funnel-for-woocommerce-pro' ),
			)
		);
		...
		$this->add_control(
			'drop_cap',
			array(
				'label'              => esc_html__( 'Drop Cap', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				'type'               => Controls_Manager::SWITCHER,
				'label_off'          => esc_html__( 'Off', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				'label_on'           => esc_html__( 'On', 'one-click-upsell-funnel-for-woocommerce-pro' ),
		...
		$text_columns[''] = esc_html__( 'Default', 'one-click-upsell-funnel-for-woocommerce-pro' );

		$this->add_responsive_control(
			'text_columns',
			array(
				'label'     => esc_html__( 'Columns', 'one-click-upsell-funnel-for-woocommerce-pro' ),
		...
		$this->add_responsive_control(
			'column_gap',
			array(
				'label'      => esc_html__( 'Columns Gap', 'one-click-upsell-funnel-for-woocommerce-pro' ),
		...
		$this->add_control(
			...
			array(
				...
				'options'      => array(
					...
					'stacked' => esc_html__( 'Stacked', 'one-click-upsell-funnel-for-woocommerce-pro' ),
					'framed'  => esc_html__( 'Framed', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				),
				'default'      => 'default',
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Primary Color', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Secondary Color', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'drop_cap_space',
			array(
				'label'     => esc_html__( 'Space', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => array(
					'size' => 10,
				),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Border Width', 'one-click-upsell-funnel-for-woocommerce-pro' ),
