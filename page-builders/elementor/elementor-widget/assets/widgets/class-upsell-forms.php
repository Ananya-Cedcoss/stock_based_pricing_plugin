 ...
 * @subpackage woocommerce-one-click-upsell-funnel-pro/widgets
 */
...
class Upsell_Forms extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Upsell Meta Forms', 'one-click-upsell-funnel-for-woocommerce-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Enter upsell meta forms shortcode', 'one-click-upsell-funnel-for-woocommerce-pro' ),
