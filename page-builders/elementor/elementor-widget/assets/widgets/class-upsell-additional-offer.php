 ...
 * @since 1.0.0
 */
class Upsell_Additional_Offer extends Widget_Base {
	...
	public function get_name() {
		return 'upsell-additional-offer';
	}
	...
	public function get_title() {
		return esc_html__( 'Upsell Additional Offer', 'one-click-upsell-funnel-for-woocommerce-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_shortcode',
			array(
				'label' => esc_html__( 'Shortcode', 'one-click-upsell-funnel-for-woocommerce-pro' ),
			)
		);
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Enter upsell image shortcode', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => array(
					'active' => true,
				),
				'placeholder' => '[wps_additional_offers]',
				'default'     => '[wps_additional_offers]',
			)
		);
