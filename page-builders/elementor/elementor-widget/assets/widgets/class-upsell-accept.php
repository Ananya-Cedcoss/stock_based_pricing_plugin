...
class Upsell_Accept extends Widget_Button {
	...
	public function get_title() {
		return __( 'Upsell Yes Button', 'one-click-upsell-funnel-for-woocommerce-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default'     => esc_html__( 'Add this to my order', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				'placeholder' => esc_html__( 'Accept button text', 'one-click-upsell-funnel-for-woocommerce-pro' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => esc_html__( 'Add Upsell yes shortcode here', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				'default'     => array(
					'url' => '[wps_upsell_yes]',
				),
			)
