 ...
 * @since 1.0.0
 */
class Upsell_Timer extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Upsell Timer', 'one-click-upsell-funnel-for-woocommerce-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Enter upsell timer shortcode', 'one-click-upsell-funnel-for-woocommerce-pro' ),
