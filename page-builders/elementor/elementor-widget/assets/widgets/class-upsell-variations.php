...
class Upsell_Variations extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Upsell Variations', 'one-click-upsell-funnel-for-woocommerce-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Enter upsell variation shortcode', 'one-click-upsell-funnel-for-woocommerce-pro' ),
