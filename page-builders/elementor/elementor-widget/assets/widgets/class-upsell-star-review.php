...
class Upsell_Star_Review extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Upsell Star Ratings', 'one-click-upsell-funnel-for-woocommerce-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'shortcode',
			array(
				'label'       => esc_html__( 'Enter upsell star review shortcode', 'one-click-upsell-funnel-for-woocommerce-pro' ),
