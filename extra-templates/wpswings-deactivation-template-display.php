...
<?php if ( ! empty( $form_fields ) ) : ?>
	<div class="wps-onboarding-section">
		...
		<div class="wps-on-boarding-wrapper">
			...
			<p class="wps-on-boarding-desc"><?php esc_html_e( 'May we have a little info about why you are deactivating?', 'one-click-upsell-funnel-for-woocommerce-pro' ); ?></p>
			<form action="#" method="post" class="wps-on-boarding-form">
				...
				<div class="wps-on-boarding-form-no_thanks">
					<a href="#" class="wps-deactivation-no_thanks"><?php esc_html_e( 'Skip and Deactivate Now', 'one-click-upsell-funnel-for-woocommerce-pro' ); ?></a>
				</div>
				</div>
			</form>
		</div>
