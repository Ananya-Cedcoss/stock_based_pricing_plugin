 ...
 * @since      3.0.0
 *
 * @package    woocommerce_one_click_upsell_funnel_pro
 * @subpackage woocommerce_one_click_upsell_funnel_pro/reporting
 */
...
class WPS_Upsell_Report_Sales_By_Date extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		switch ( $this->chart_groupby ) {
			case 'day':
				$average_total_sales_title = sprintf(
					...
					esc_html__( 'average net daily upsell sales', 'one-click-upsell-funnel-for-woocommerce-pro' )
				);
			...
			default:
				...
				$average_total_sales_title = sprintf(
					'<strong>%s</strong> %s',
					wc_price( $data->average_total_sales ),
					esc_html__( 'average net monthly upsell sales', 'one-click-upsell-funnel-for-woocommerce-pro' )
				);
				break;
		}
		...
		$legend[] = array(
			'title'            => sprintf(
				...
				__( '%s net upsell sales in this period', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				'<strong>' . wc_price( $data->total_sales ) . '</strong>'
			),
			'placeholder'      => __( 'This is the sum of the upsell item totals after any refunds ( whole order refunds ) and excluding shipping and taxes.', 'one-click-upsell-funnel-for-woocommerce-pro' ),
		...
		$legend[] = array(
			'title'            => sprintf(
				...
				__( '%s upsell orders placed', 'one-click-upsell-funnel-for-woocommerce-pro' ),
		...
		$legend[] = array(
			'title'            => sprintf(
				...
				__( '%s upsell items purchased', 'one-click-upsell-funnel-for-woocommerce-pro' ),
		...
		$legend[] = array(
			...
			/* translators: %s: refunded sales */
				__( '%s upsell refunded items', 'one-click-upsell-funnel-for-woocommerce-pro' ),
				'<strong>' . $data->refunded_order_items . '</strong>'
			),
			'placeholder'      => __( 'Total upsell refunded items from fully refunded orders.', 'one-click-upsell-funnel-for-woocommerce-pro' ),
	...
	public function get_export_button() {
		...
		<a
			...
			class="export_csv"
			data-export="chart"
			data-xaxes="<?php esc_attr_e( 'Date', 'one-click-upsell-funnel-for-woocommerce-pro' ); ?>"
	...
	<script type="text/javascript">
		...
		var series = [
			...
			{
				label: "<?php echo esc_js( __( 'Number of orders', 'one-click-upsell-funnel-for-woocommerce-pro' ) ); ?>",
			...
			{
				label: "<?php echo esc_js( __( 'Average net sales amount', 'one-click-upsell-funnel-for-woocommerce-pro' ) ); ?>",
			...
			{
				label: "<?php echo esc_js( __( 'Net sales amount', 'one-click-upsell-funnel-for-woocommerce-pro' ) ); ?>",
